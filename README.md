...
Текущий репозиторий включает только бэкенд часть приложения. С фронтенд частью вы можете ознакомиться, перейдя по ссылке [frontend](https://github.com/ValentinShalamov/Point-Checker-Web-Frontend)
